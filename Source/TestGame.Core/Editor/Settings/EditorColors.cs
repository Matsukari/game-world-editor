...
namespace Raven.Sheet
{
  public class EditorColors
  {
    ...
    public Color GridOutline = new Color(0.0f, 0.0f, 0.0f, 0.5f);

    public Color PickHoverOutline = new Color(0.5f, 0.5f, 0.5f, 1f);
    public Color PickHover = new Color(0.5f, 0.5f, 0.5f, 0.5f);
