...
namespace Raven.Sheet
{
  public class ViewMenubar : Editor.SubEntity
  {
    ...
    void RenderImGui()
    {
      ...
      void BeginStackBar(string name)
      {
        ...
        var size = new Vector2(Screen.Width, 45);
      ...
      if (ImGui.BeginMainMenuBar())
      {
        ...
        {
          if (ImGui.BeginMenu(menubarButton.Item1)) menubarButton.Item2.Invoke();
        }
        ImGui.EndMainMenuBar();
      }

      // // Start of file tabs
      // BeginStackBar("files-bar");



      // Start of tools bar
      BeginStackBar("tools-bar");
